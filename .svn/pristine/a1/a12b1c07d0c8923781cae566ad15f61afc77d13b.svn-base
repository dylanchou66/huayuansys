        ...
        table: {
                ...
                table1.bootstrapTable({
                    ...
                    columns: [
                        [
                            ...
                            {field: 'number', title: '未结算(个):',operate: false},
                ...
                table2.bootstrapTable({
                    ...
                    columns: [
                        [
                            ...
                            {field: 'ttl', title: '未结算(笔):',operate: false},
                            {field: 'money', title: '金额:',operate: false},
                            {
            ...
            third: function () {
                ...
                table3.bootstrapTable({
                    url: 'deduction/table3',
                    extend: {
                        index_url: '',
                        add_url: '',
                        edit_url: '',
                        del_url: 'deduction/deduction',
                        multi_url: '',
                    ...
                    columns: [
                        [
                            ...
                            {checkbox: true,formatter:function(value, row, index){
                                    ...
                                    if (row.zeren == '3' || row.zeren == '4' || row.zeren == '2'){
                            ...
                            {field: 'operate', title: __('Operate'), table: table3,buttons: [
                                    {name: 'check', text: '查看详情', title: '查看详情', icon: 'fa fa-paint-brush', classname: 'btn btn-xs btn-info btn-dialog   ',extend:'data-area=\'["600px","650px"]\'', url: 'claims/one'}
...
// $(table).data("operate-edit", null);
                    ...
                    return Table.api.formatter.operate.call(that, value, row, index);
                            ...
                            {field: 'claims_id', title: '申请单号'},
                            {field: 'date', title: '发生日期', operate:'RANGE', addclass:'datetimerange',formatter: Table.api.formatter.datetime, datetimeFormat:"YYYY-MM-DD"},
                            {field: 'money', title: '金额', operate: false},
